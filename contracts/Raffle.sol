 ...
 *  @dev This implemens ChainLink VRF v2 and ChainLink Keepers
 */
...
contract Raffle is VRFConsumerBaseV2, KeeperCompatibleInterface {
    ...
    enum RaffleState {
        OPEN,
        CALCULATING
    } // This enum => uint256 where 0 = open, 1 = calculating

    /* State Variables */
    uint256 private immutable i_entranceFee;
    address payable[] private s_players;
    VRFCoordinatorV2Interface private immutable i_vrfCoordinator;
    bytes32 private immutable i_gasLnae;
    ...
    function enterRaffle() public payable {
        ...
        // tip --> name the events with the function name reversed
     ...
     * 1. Our time inverl should have passed
